...
for i in range(100):
    ...
    if minVal > 0.05:
        break
    croi = bsrc[minLoc[1]:minLoc[1]+h, minLoc[0]:minLoc[0]+w]
    id = filename + "_unit%d.jpg" % i
    ...
    cv2.rectangle(bsrc, minLoc, (minLoc[0]+w, minLoc[1]+h), (255, 0, 0), -1)
